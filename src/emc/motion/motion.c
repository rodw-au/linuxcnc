...
static int init_hal_io(void)
{
    ...
    /* state tags pins */
    CALL_CHECK(hal_pin_bit_newf(HAL_OUT, &(emcmot_hal_data->tag_arc_is_circle), mot_comp_id, "interp.is-circle"));   
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->feed_upm), mot_comp_id, "motion.feed-upm"));
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->tag_feed_upm), mot_comp_id, "interp.feed-rate-upm")); 
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->tag_feed_ups), mot_comp_id, "interp.feed-rate-ups"));    
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->arc_radius), mot_comp_id, "interp.arc-radius"));
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->arc_radius_center_x), mot_comp_id, "interp.arc-center-x"));
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->arc_radius_center_y), mot_comp_id, "interp.arc-center-y"));
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->arc_heading), mot_comp_id, "interp.heading"));
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->tag_speed), mot_comp_id, "interp.speed")) < 0 goto error;    
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->tag_path_tolerance), mot_comp_id, "interp.path-tolerance"));    
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->tag_tool_radius), mot_comp_id, "interp.tool-radius"));  
    CALL_CHECK(hal_pin_float_newf(HAL_OUT, &(emcmot_hal_data->tag_naive_cam_tolerance), mot_comp_id, "interp.naive-cam-tolerance"))            
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_arc_plane), mot_comp_id, "interp.arc_plane"));
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_line_number), mot_comp_id, "interp.program-line"));  
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_cutter_comp), mot_comp_id, "interp.cutter-comp"));  
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_gmode_0), mot_comp_id, "interp.gmode-0"));  
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_motion_mode), mot_comp_id, "interp.motion-mode"));  
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_m_modes_4), mot_comp_id, "interp.m-modes-4"));  
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_origin), mot_comp_id, "interp.origin")); 
    CALL_CHECK(hal_pin_s32_newf(HAL_OUT, &(emcmot_hal_data->tag_toolchange), mot_comp_id, "interp.toolchange"));
    CALL_CHECK(hal_pin_u32_newf(HAL_OUT, &(emcmot_hal_data->tag_packed_flags), mot_comp_id, "interp.packed-flags"));
